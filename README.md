...
A small self-contained tool for tracking electricity plan rates for one household (currently: F 2/5 Woids Ave, Hurstville NSW 2220, Ausgrid network) and figuring out which plan is actually cheapest given real usage — not the generic annual estimate a comparison site shows.
